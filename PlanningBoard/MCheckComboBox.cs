...
namespace PlanningBoard
{
    ...
    /// </summary>
    public class MCheckComboBoxItem
    {
        /// <summary>
        /// C'tor - creates a MCheckComboBoxItem
        /// </summary>
        ...
        public MCheckComboBoxItem( string text, bool initialCheckState )
        {
    ...
    /// </summary>
    public partial class MCheckComboBox : ComboBox
    {
        /// <summary>
        /// C'tor
        /// </summary>
        public MCheckComboBox()
        {
        ...
        /// of the MCheckComboBoxItem and fires the public event CheckStateChanged using the 
        /// MCheckComboBoxItem as the event sender.
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        void CheckComboBox_SelectedIndexChanged( object sender, EventArgs e )
        {
            MCheckComboBoxItem item = (MCheckComboBoxItem)SelectedItem;
        ...
        void CheckComboBox_DrawItem( object sender, DrawItemEventArgs e )
        {
			...
			if( !( Items[ e.Index ] is MCheckComboBoxItem ) )
			{
			...
			// get the MCheckComboBoxItem from the collection
			MCheckComboBoxItem box = (MCheckComboBoxItem)Items[ e.Index ];
